...
import { SupersetPluginChartBararea } from 'superset-plugin-chart-bararea';
import { SupersetPluginChartBigtext } from 'superset-plugin-chart-bigtext';
import TablePivotNewChartPlugin from '@superset-custom/plugin-chart-pivot-table';
import { LiquidChartPlugin } from 'superset-plugin-chart-liquid2';
import { SupersetPluginChartVerticalbar } from 'superset-plugin-chart-verticalbar';
  ...
  constructor() {
    ...
    super({
      ...
      plugins: [
        ...
        new SupersetPluginChartBidirectionalbar().configure({
          key: 'superset-plugin-chart-bidirectionalbar',
        }),
        new SupersetPluginChartVerticalbar().configure({
          key: 'superset-plugin-chart-verticalbar',
        }),
        new TablePivotNewChartPlugin().configure({
          key: 'nielsen-oss-table-pivot',
        }),
        new SupersetPluginChartBararea().configure({
          key: 'superset-plugin-chart-bararea',
        }),
        new SupersetPluginChartBigtext().configure({
          key: 'superset-plugin-chart-bigtext',
        }),
